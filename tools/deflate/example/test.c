...
int main()
{
	...
	char data[BUFFER_SIZE] =
		"This is an example for DEFLATE compression and decompression!\0";
	...
	if (deflate_deflate_decompress(decompressor, compressed, out_nbytes,
				       extracted, data_len, &restore_nbytes)) {

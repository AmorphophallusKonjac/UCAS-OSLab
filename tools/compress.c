...
int main() {
    ...
    /* do compress */
    int out_nbytes = deflate_deflate_compress(compressor, data, nbytes_kernel,
                                              compressed, nbytes_kernel + 10);
    ...
    deflate_deflate_decompress(decompressor, compressed, out_nbytes, extracted,
                               1000000, &restore_nbytes);
